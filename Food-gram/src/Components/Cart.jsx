      ...
      {cart.map((item) => (
        <div key={item.id} className="mb-2 flex justify-between">
          ...
          <div className="flex items-center">
            ...
            <button onClick={() => removeFromCart(item.id)} className="tooltip flex flex-col justify-center items-center p-3 border-0 bg-opacity-25 bg-indigo-500/10 rounded-full transition-all duration-200 ease-linear hover:shadow-sm ml-2 text-red-500">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" class="h-6 w-6">
